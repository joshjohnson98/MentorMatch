...
window.onload = function() {
  ...
  console.log("the email when load is: " + localStorage.getItem("useremail"));

  angular.element($('#MainWrap')).scope().detailedInfo.email = localStorage.getItem('useremail');
  // angular.element($('#MainWrap')).scope().login(localStorage["useremail"],localStorage["username"]);
